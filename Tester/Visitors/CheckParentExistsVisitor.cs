...
namespace Tester
{
    class CheckParentExistsVisitor : IVisitor
    {
        ...
        public void VisitOnOn(InsertStmt insertStmt, int offset)
        {
            this.ParentExists(insertStmt);
        }

        public void VisitOnDo(InsertStmt insertStmt, int offset)
        {
            this.ParentExists(insertStmt);
        }

        public void VisitOnWhere(InsertStmt insertStmt, int offset)
        {
            this.ParentExists(insertStmt);
        }
